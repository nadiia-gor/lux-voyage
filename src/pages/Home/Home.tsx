    ...
    return (
        <div className="home--container">
            ...
            <div className="home--products-container">
                <img src="src/assets/images/1585002.svg" alt="svg" />
